...
class FilterDataComponent(Component):
    ...
    def filter_vacation_data(
        self, vacation_data: list[dict[str, Any]], *dates: str
    ) -> list[dict[str, Any]]:
    ...
    def _should_include_person(
        self, person: dict, operation: str, parsed_dates: tuple
    ) -> bool:
    ...
    def filter_money_data(
        self, money_data: list[dict[str, Any]], *amounts: int
    ) -> list[dict[str, Any]]:
    ...
    def _should_include_item(
        self, person: dict, operation: str, parsed_amounts: list
    ) -> bool:
